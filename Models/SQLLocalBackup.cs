...
namespace ShawkanyDb.Models
{
    ...
    public class SQLLocalBackup
    {
        ...
        protected string _dbname = "ShawkanyDb";
        public SQLLocalBackup()
        {
            var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json");
            // var builder = new ConfigurationBuilder().SetBasePath(Directory.GetDirectories()).AddJsonFile("appsettings.json");
